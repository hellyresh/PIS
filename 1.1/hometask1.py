...
for i in range(7, 24):  # 24, а не 23, потому что если писать 23 - выведется только до 22
    print(i)
...
for i in range(100, 9, -10):  # если вторым аргументом писать 10, оно само не выведется
    print(i)
